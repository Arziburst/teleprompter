export const DEFAULT_PLACEHOLDER = `This is a simple teleprompter made for practice interviews, talks, and short videos.
...
export const TELEPROMPTER_FONT_MIN = 28;
export const TELEPROMPTER_FONT_MAX = 80;
export const FONT_STEP_EDITOR = 2;
export const FONT_STEP_TELEPROMPTER = 4;
export const SPEED_STEP = 0.1;
export const AVERAGE_WORDS_PER_MINUTE = 140;
